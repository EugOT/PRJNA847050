...
```{python}
adata_norm.uns["liana_res"].to_csv("arc_astro-with_npy_pomc-liana-res-cellchatdb.csv")
...
n2a_norm.save(filename="liana-dotplot-logfc-normal-diet-n2a-insr-status-cellchatdb.pdf")
```
...
n2a_norm.save(
    filename="liana-dotplot-specificity_rank-normal-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_norm.save(
    filename="liana-dotplot-magnitude_rank-normal-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
a2n_norm.save(filename="liana-dotplot-logfc-normal-diet-a2n-insr-status-cellchatdb.pdf")
```
...
a2n_norm.save(
    filename="liana-dotplot-specificity_rank-normal-diet-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_norm.save(
    filename="liana-dotplot-magnitude_rank-normal-diet-a2n-insr-status-cellchatdb.pdf"
)
```
...
```{python}
adata_norm.write(
    f"/data/{bioproject}/data/velocity-signalling/{bioproject}-signalling-norm-insr-status-cellchatdb.h5ad"
)
```
...
adata_hfd.var_names = [x.upper() for x in adata_hfd.var_names]
...
```{python}
adata_hfd.uns["liana_res"].to_csv(
...
n2a_hfd.save(filename="liana-dotplot-logfc-HFHS-diet-n2a-insr-status-cellchatdb.pdf")
```
...
n2a_hfd.save(
    filename="liana-dotplot-specificity_rank-HFHS-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_hfd.save(
    filename="liana-dotplot-magnitude_rank-HFHS-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
a2n_hfd.save(filename="liana-dotplot-logfc-HFHS-diet-a2n-insr-status-cellchatdb.pdf")
```
...
a2n_hfd.save(
    filename="liana-dotplot-specificity_rank-HFHS-diet-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_hfd.save(
    filename="liana-dotplot-magnitude_rank-HFHS-diet-a2n-insr-status-cellchatdb.pdf"
)
```
...
```{python}
adata_hfd.write(
    f"/data/{bioproject}/data/velocity-signalling/{bioproject}-signalling-treatment-insr-status-cellchatdb.h5ad"
)
```
